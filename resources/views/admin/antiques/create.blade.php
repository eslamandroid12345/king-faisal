        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{route('antiques.store')}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="category_{{$locale}}"  class="form-control" value="{{old('category_'.$locale)}}">
                                    </div>
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="period_{{$locale}}"  class="form-control" value="{{old('period_'.$locale)}}">
                                        </div>
                                ...
                                @foreach (config('translatable.locales') as $locale)
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="material_{{$locale}}"  class="form-control" value="{{old('material_'.$locale)}}">
                                        </div>
                                ...
                                @foreach (config('translatable.locales') as $locale)
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" name="origin_{{$locale}}"  class="form-control" value="{{old('origin_'.$locale)}}">
                                        </div>
                                ...
                                @foreach (config('translatable.locales') as $locale)
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="form-group">
                                            ...
                                            <textarea style="height: 300px" name="description_{{$locale}}"  class="form-control">{{old('description_'.$locale)}}</textarea>
                                        </div>
