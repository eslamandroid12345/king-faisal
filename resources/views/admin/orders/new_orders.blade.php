...
@section('css')
    @section('title')
        {{trans('dashboard.new_orders_section')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('finished_status',$order->id)}}"><i style="color: #0000cc" class="fa fa-hand-o-left"></i>&nbsp;{{trans('dashboard.finished')}}&nbsp;</a>
                                                            <a class="dropdown-item" href="{{route('in_progress_status',$order->id)}}"><i style="color: #9dc8e2" class="fas fa-refresh"></i>&nbsp; &nbsp; {{trans('dashboard.in_progress')}}</a>
                                                            <a class="dropdown-item" href="{{route('refused_status',$order->id)}}"><i style="color:goldenrod" class="fas fa-trash"></i>&nbsp; &nbsp;{{trans('dashboard.refused')}}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
