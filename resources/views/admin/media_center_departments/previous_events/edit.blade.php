        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{route('previous_events.update',$previous_event->id)}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="title_{{$locale}}"  class="form-control" value="{{$previous_event->translate($locale)->title}}">
                                    </div>
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_{{$locale}}"  class="form-control">{{$previous_event->translate($locale)->description}}</textarea>
                                    </div>
                            ...
                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"  id="datepicker-action" name="published_date" data-date-format="yyyy-mm-dd" value="{{$previous_event->published_date}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <div class="col-md-12 mt-4 mb-3">
                                    <img style="width: 30%;border-radius: 4px" src="{{asset($previous_event->image_url)}}">
