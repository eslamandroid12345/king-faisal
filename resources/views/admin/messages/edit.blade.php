        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{route('messages.update',$message->id)}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <h6color: blue">{{trans('dashboard.message_title')}}</h6><br>
                        <div class="row">
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="title_{{$locale}}"  class="form-control" value="{{$message->translate($locale)->title}}">
                                    </div>
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_{{$locale}}"  class="form-control">{{$message->translate($locale)->description}}</textarea>
                                    </div>
