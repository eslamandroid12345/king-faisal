...
@section('css')
    @section('title')
        {{trans('dashboard.information_request_accepted')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('information_requests.finished_update',$order->id)}}"><i style="color: #0000cc" class="fa fa-check"></i>&nbsp;اتمام الطلب&nbsp;</a>
                                                            <a class="dropdown-item" href="{{route('information_requests.refused_update',$order->id)}}"><i style="color:goldenrod" class="fas fa-close"></i>&nbsp; &nbsp;رفض الطلب</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
