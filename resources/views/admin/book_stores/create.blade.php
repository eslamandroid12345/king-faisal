        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{route('books.store')}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="series_{{$locale}}"  class="form-control" value="{{old('series_'.$locale)}}">
                                    </div>
                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="cover_{{$locale}}"  class="form-control" value="{{old('cover_'.$locale)}}">
                                    </div>
                        ...
                        @foreach (config('translatable.locales') as $locale)
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="additional_information_{{$locale}}"  class="form-control">{{old('additional_information_'.$locale)}}</textarea>
                                </div>
                  ...
                  {{--فهرس الكتاب--}}
                    @foreach (config('translatable.locales') as $locale)
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-group">
                                ...
                                <textarea name="contents_{{$locale}}"  class="form-control">{{old('contents_'.$locale)}}</textarea>
                            </div>
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="form-group">
                            ...
                            <select class="custom-select mr-sm-2" name="book_type">
                                ...
                                <option  value="soft_copy">Hard Copy</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mt-3">
                        <div class="form-group">
                            ...
                            <input  type="number" name="printing_number"  class="form-control" min="1" value="{{old('printing_number')}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select mr-sm-2" name="book_category_id">
                                ...
                                @foreach($book_categories as $book_category)
                                    <option  value="{{$book_category->id}}">{{$book_category->translate(lang())->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
