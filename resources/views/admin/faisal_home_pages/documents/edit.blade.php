        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{route('documents.update',$document->id)}}" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4 mb-3">
                                <img style="width: 30%;border-radius: 4px" src="{{asset($document->image)}}">
                        ...
                        @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description_{{$locale}}"  class="form-control">{{$document->translate($locale)->description}}</textarea>
                                    </div>
