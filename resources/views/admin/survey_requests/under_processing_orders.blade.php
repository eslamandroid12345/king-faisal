...
@section('css')
    @section('title')
        {{trans('dashboard.under_processing_orders')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tbody>
                                        @foreach($under_processing_orders as $order)
                                            <tr>
                                                <td>{{$order->id}}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('survey_requests.finished_update',$order->id)}}"><i style="color: #ffc107" class="fa fa-hand-o-left"></i>&nbsp;{{trans('dashboard.finished_order')}}&nbsp;</a>
                                                            <a class="dropdown-item" href="{{route('survey_requests.refused_update',$order->id)}}"><i style="color:goldenrod" class="fas fa-trash"></i>&nbsp; &nbsp;{{trans('dashboard.refused')}}</a>
