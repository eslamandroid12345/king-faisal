...
@section('css')
    @section('title')
        {{trans('dashboard.finished_orders')}}
    @stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                                ...
                                                <td>
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('survey_requests.payment_details',$order->id)}}"><i style="color: #ffc107" class="fas fa-money-bill-alt"></i>&nbsp; &nbsp;{{trans('dashboard.payment_details')}}</a>
