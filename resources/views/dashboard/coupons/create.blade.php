            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('coupons.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input  type="text" name="coupon_code" class="form-control" id="exampleInputName1" value="{{old('coupon_code')}}">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input  type="number" min="1" name="discount_value" class="form-control" id="exampleInputName1"  value="{{old('discount_value')}}">
                                    </div>


                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">{{trans('dashboard.start_date')}}</label>
                                        <input  type="date" name="start_date" class="form-control" id="exampleInputName1"  value="{{old('start_date')}}">
                                    </div>


                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">{{trans('dashboard.end_date')}}</label>
                                        <input  type="date" name="end_date" class="form-control" id="exampleInputName1"  value="{{old('end_date')}}">
                                    </div>

                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">{{trans('dashboard.max_usage')}}</label>
                                        <input  type="number" min="1" name="max_usage"  class="form-control" id="exampleInputName1" value="{{old('max_usage')}}">
                                    </div>
