            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('sliders.update',$slider->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        ...
                                        <input  type="text" name="url" class="form-control" id="exampleInputName1" value="{{$slider->url}}">
                                    </div>
