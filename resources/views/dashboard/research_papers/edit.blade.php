            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('research_papers.update',$research_paper->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-4 col-12">
                                            ...
                                            <input  type="text" name="title_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$research_paper->translate($locale)->title}}">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <select id="research_department_id" name="research_department_id" class="form-control">
                                            @foreach($research_paper_departments as $research_paper_department)
                                                <option  value="{{$research_paper_department->id}}" {{$research_paper->research_department_id == $research_paper_department->id ? 'selected' : ''}}>{{$research_paper_department->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <select id="show_home_page" name="show_home_page" class="form-control">
                                            ...
                                            <option  value="1" {{$research_paper->show_home_page == 1 ? 'selected' : ''}}>Yes</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input  type="text" name="editor" class="form-control" id="exampleInputName1" value="{{$research_paper->editor}}">
                                    </div>
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote{{$i++}}" name="description_{{$locale}}"  class="form-control" >{{$research_paper->translate($locale)->description}}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
