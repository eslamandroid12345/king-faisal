            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('about_us_informations.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <textarea id="summernotec{{$j++}}" name="header_{{$locale}}"  class="form-control" >{{old('header_'.$locale)}}</textarea>
