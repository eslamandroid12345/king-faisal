...
@section('title',trans('dashboard.message_deposit_title'))
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>  {{trans('dashboard.message_deposit_title')}}</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">     {{trans('dashboard.message_deposit_title')}}</h3>
                            <div class="card-tools">
                                {{--start search model--}}
                                <a href="{{route('message_deposits.index')}}" style="color: #fff" class="btn btn-dark waves-effect waves-light"><i class="fa fa-spinner"></i> </a>
                        ...
                        <div style="overflow-x: auto" class="card-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                @forelse($message_deposits as $message)
                                    <tr>
                                        <td>{{$message->id}}</td>
                                                ...
                                                <div id="delete-modal{{$message->id}}" class="modal fade modal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">                                                    <div class="modal-dialog">
                                                        <div class="modal-content float-left">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('message_deposits.destroy',$message->id)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                        ...
                        <div class="card-footer">
                            <div>{{$message_deposits->links()}}</div>
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
