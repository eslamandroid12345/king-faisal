            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('managements.update',$management->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        <label for="exampleInputName1">{{trans('dashboard.name')}} </label>
                                        <input  type="text" name="name" class="form-control" id="exampleInputName1" value="{{$management->name}}">
                                    </div>


                                    @foreach (config('translatable.locales') as $locale)
                                        <div class="form-group col-md-12 col-12">
                                            <label for="exampleInputName1">{{trans('dashboard.role_'.$locale)}}</label>
                                            <input  type="text" name="role_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$management->translate($locale)->role}}">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote{{$i++}}" name="description_{{$locale}}"  class="form-control" >{{$management->translate($locale)->description}}</textarea>
                                            </div>
