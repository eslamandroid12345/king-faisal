            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('managements.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                @foreach (config('translatable.locales') as $locale)
                                    <div class="form-group col-md-12 col-12">
                                        ...
                                        <input  type="text" name="role_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{old('role_'.$locale)}}">
