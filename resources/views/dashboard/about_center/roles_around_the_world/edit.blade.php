...
@section('title',trans('dashboard.RolesAroundTheWorld'))
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> {{trans('dashboard.RolesAroundTheWorld')}}</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('roles_around_the_world_sections.update',$roles_around_the_world_section->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title"> {{trans('dashboard.RolesAroundTheWorld')}}</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input  type="text" name="title_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$roles_around_the_world_section->translate($locale)->title}}">
                                        </div>
                                    @endforeach
