            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('chairman_of_the_board_news.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input name="published_date" type="date" class="form-control" id="exampleInputName1" >
                                    </div>
