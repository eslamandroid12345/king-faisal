            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('chairman_of_the_board_news.update',$chairman_of_the_board_new->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input  type="text" name="title_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$chairman_of_the_board_new->translate($locale)->title}}">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote{{$i++}}" name="description_{{$locale}}"  class="form-control" >{{$chairman_of_the_board_new->translate($locale)->description}}</textarea>
                                            </div>
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">{{trans('dashboard.published_date')}}</label>
                                        <input name="published_date" type="date" class="form-control" id="exampleInputName1" value="{{$chairman_of_the_board_new->published_date}}">
                                    </div>
