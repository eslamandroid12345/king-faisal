            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('news.update',$new->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input  type="text" name="title_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$new->translate($locale)->title}}">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote{{$i++}}" name="description_{{$locale}}"  class="form-control" >{{$new->translate($locale)->description}}</textarea>
                                            </div>
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input  type="date" name="published_date" class="form-control" id="exampleInputName1"  value="{{$new->published_date}}">
                                    </div>
