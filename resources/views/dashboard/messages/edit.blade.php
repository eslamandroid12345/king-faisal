...
@section('title',trans('dashboard.message_title'))
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>            {{trans('dashboard.message_title')}}</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('messages.update',$message->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title"> {{trans('dashboard.message_title')}}</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input  type="text" name="title_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$message->translate($locale)->title}}">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote{{$i++}}" name="description_{{$locale}}" type="text"  class="form-control" id="summernote">{{$message->translate($locale)->description}}</textarea>
                                            </div>
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        <label for="exampleInputFile">{{trans('dashboard.aspiration_icon')}}</label>
