                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                {{--start search model--}}
                                <a href="{{route('messages.create')}}"><button class="btn btn-dark waves-effect waves-light">{{trans('dashboard.create_model')}}</button></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{route('messages.edit',$message->id)}}"> <button class="btn btn-dark waves-effect waves-light">{{trans('dashboard.update_model')}}</button></a>
