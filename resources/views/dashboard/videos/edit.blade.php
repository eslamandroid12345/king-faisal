            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('media_center_videos.update',$video->id)}}" method="post" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            ...
                                            <input  type="text" name="title_{{$locale}}"  class="form-control" id="exampleInputName1" value="{{$video->translate($locale)->title}}">
                                    ...
                                    @foreach (config('translatable.locales') as $locale)
                                        ...
                                        <div class="form-group col-md-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote{{$i++}}" name="description_{{$locale}}"  class="form-control" >{{$video->translate($locale)->description}}</textarea>
                                            </div>
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">@lang('dashboard.media_center_department_published_date')</label>
                                        <input  type="date" name="published_date"  class="form-control" id="exampleInputName1" value="{{$video->published_date}}">

                                    </div>

                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">@lang('dashboard.media_center_department_video_url')</label>
                                        <input  type="text" name="video_url"  class="form-control" id="exampleInputName1" value="{{$video->video_url}}">

                                    </div>


                                    <div class="form-group col-md-12 col-12">
                                        <label for="exampleInputFile">@lang('dashboard.media_center_department_image_url')</label>
