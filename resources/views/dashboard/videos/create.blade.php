            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form  action="{{route('media_center_videos.store')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                @foreach (config('translatable.locales') as $locale)
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        <input  type="date" name="published_date"  class="form-control" id="exampleInputName1" value="{{old('published_date')}}">

                                    </div>

                                    <div class="form-group col-md-6 col-12">
                                        <label for="exampleInputName1">@lang('dashboard.media_center_department_video_url')</label>
                                        <input  type="text" name="video_url"  class="form-control" id="exampleInputName1" value="{{old('video_url')}}">
