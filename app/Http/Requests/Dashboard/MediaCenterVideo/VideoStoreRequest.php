...
namespace App\Http\Requests\Dashboard\MediaCenterVideo;
...
class VideoStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'video_url.required' => trans('dashboard.media_center_department_video_url_required'),
            'video_url.url' => trans('dashboard.media_center_department_video_url_url'),
