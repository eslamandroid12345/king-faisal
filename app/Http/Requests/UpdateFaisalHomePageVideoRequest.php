...
class UpdateFaisalHomePageVideoRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'video_url.required' => trans('dashboard.video_url_required'),
            'video_url.url' => trans('dashboard.video_url_url'),
