...
class VideoTableSeeder extends Seeder
{
    ...
    public function run()
    {
        for ($i = 1 ; $i <= 16 ; $i++){
            ...
            $mediaDepartmentCenter->image_url = "storage/media_center_departments/images/videos/".$i.".png";
            $mediaDepartmentCenter->video_url = "https://youtube.com";
            $mediaDepartmentCenter->type = "video";
            $mediaDepartmentCenter->save();
            $mediaDepartmentCenter->translateOrNew("ar")->title =  "حلقة نقاش: الكتب والصناديق والمعروضات: استكشاف الجوانب الخفية لحفظ الورق";
            $mediaDepartmentCenter->translateOrNew("en")->title = "Panel Discussion: Books, Boxes and Displays: Exploring the Hidden Aspects of Paper Conservation";
            $mediaDepartmentCenter->translateOrNew("ch")->title = "小組討論：書籍、盒子和展示品：探索紙張保護的隱藏面";
